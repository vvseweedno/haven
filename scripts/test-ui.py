...
with sync_playwright() as p:
    ...
    expect(page.locator(".workspace-main")).to_have_attribute("aria-hidden", "true")
    expect(page.locator(".workspace-main")).to_have_attribute("inert", "")
    expect(page.get_by_role("button", name="Close navigation")).to_be_focused()
    page.keyboard.press("Shift+Tab")
    expect(page.locator(".sidebar")).to_contain_text("HAVEN")
