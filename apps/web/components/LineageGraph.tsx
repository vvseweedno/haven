  ...
  const edges = useMemo<Edge[]>(
    () => [
      ...
      },
      {
        ...
        label: localize(
          locale,
          "fixture continuity evidence",
          "фикстура доказательства непрерывности",
        ),
      },
      {
        id: "agent-to-merge",
        ...
        label: localize(
          locale,
          "fixture branch conflict",
          "фикстура конфликта ветвей",
        ),
      },
    ],
  ...
  return (
    <div
      ...
      aria-label={localize(
        ...
        "Иллюстративный граф происхождения",
      )}
    >
      <ReactFlow
        nodes={nodes}
